...
const photoFiles = [
  'cascada-velo-de-novia (1).jpg',
  'cascada-velo-de-novia (2).jpg',
  'cascada-velo-de-novia (3).jpg',
  'cascada-velo-de-novia (4).jpg',
  'cascada-velo-de-novia (5).jpg',
  'cascada-velo-de-novia (6).jpg',
  'cascada-velo-de-novia (7).jpg',
  'cascada-velo-de-novia (8).jpg',
  'cascada-velo-de-novia (9).jpg',
  'cascada-velo-de-novia (10).jpg',
];
...
export default function Gallery() {
  ...
  const photos = photoFiles.map((file, i) => ({
    src: `/gallery/${file}`,
    alt: captions?.[i] || `Cascada Velo de Novia ${i + 1}`,
  }));
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-8">
              <a
                href="https://maps.app.goo.gl/ackDBs5M4dCWDmJu6"
                target="_blank"
